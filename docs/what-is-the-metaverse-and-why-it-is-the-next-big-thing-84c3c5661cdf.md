...
Source: Galaxy Digital Research, JP Morgan, 2022
...
元宇宙是注定要消亡的白日梦和炒作吗？元宇宙不是一个白日梦，而是一个只有在某些关键条件得到满足时才能实现的无限可能性的大杂烩。这些条件包括其基础技术的大规模改进，解决数据和隐私问题，从监管滑铁卢中幸存下来，以及改善其商业基础设施。
