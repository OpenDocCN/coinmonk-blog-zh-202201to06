...
我接受了报价，并立即得到了硬币(减去市场税和一些其他扣除)，我很快去为#3dMOON 兑换硬币。原来，我通常使用的交易所与其他分散的市场有竞争硬币项目，并希望向我收取额外的费用，因为我为我的 NFT 存放了硬币。我必须做更多的研究来找到一个不会收我很多钱的交易所。在花了比我真正想要的更多的时间四处寻找之后，我设法以接近协议费的费用进行了存款。这个改变进行得很顺利，所以现在我终于有东西来支付我的 3D 工具并创建更多的 NFT 了！
...
今天，#3dMOON 工具背后的刀决定提高价格，作为对最近汇率下跌的反应。他们通过对公共区块链的智能合同进行分散投票来实现这一目标。每个用户都可以投票，因为他们在使用该工具时还持有#3dMOON 硬币，以支付每小时的微交易费用。事实是，真正的用户(3d 艺术家、建模师和动画师)在使用工具时必须花费他们的硬币，所以他们总是比那些只是为了利润而持有硬币的人少。咄…看来我该开始寻找额外的收入来源了。

从积极的一面来看，如今做一名投资者非常容易，我也是一些独立硬币的自豪拥有者。然而，不知何故，如果用法定货币来衡量，我的许多硬币仍然与它们潜在的核心协议的主要硬币有很强的相关性。是的，当然，我 2 个月前买的代币，当时我有点醉了，还患有 FOMO，结果是另一个骗局。是的，我可以在一个进行背景调查的正规交易所的官方 ICO 上购买，但每个人都在说，如果你想获得真正的利润，你需要在早期阶段参与进来。我的买家承诺给人们的工作方式带来一场新的革命。他们承诺了一个完全分散的 3D 环境，完全可以通过 VR 耳机和手套访问，而不是在现实世界中在家里或办公室里使用笔记本电脑工作。无需键盘或显示器，只需“即插即用”。作为一个用户，你用他们卖给你的硬币租了一个“房间”,并在你支持区块链的 RaspberryPi 版本上安装了一个免费的客户端应用程序。他们承诺，这可以让你付费或免费加入其他人的房间，甚至可以租一个设计师设计的房间来“进入正确的情绪”。演示的特色是海滩上的“房间”，五星级酒店，甚至是苹果或谷歌最初起步的车库的复制品。

事实证明，这些家伙从来没有设法创建实际的运行在 RPi 19 上的软件；相反，他们所做的只是在元宇宙租用一些不太知名的空间来制作宣传片——仅此而已。可怜的我！我怎么会知道！我只希望下次我的运气会好一点。

反正我剩下的代币做的还不错，相对来说。我通常更喜欢自动重新平衡投资组合的 DeFi 投资产品。我信任他们，但必须关注他们的佣金，因为有时他们会在协议费随着需求增加(或飙升)的时候重新平衡，而我最终会支付比预期更多的费用。根据社区的说法，他们是值得信赖的。它们也是分散的，而且，因为它们中的一些是为了赚取我需要的#3dMOON 硬币而设计的，所以我保留着它们。然而，后来事情发生了意想不到的变化，原来他们投资于 3D 艺术家的 Dao，这些艺术家采用了#3dMOON 硬币作为他们的主要货币，因为实际工具的许可价格上涨，这些 Dao 的收入下降，我的投资价值也下降了。

好的一面是，我使用的应用程序都在区块链上，因此是分散的。

# 0b0101。**星期五。社区是关键。”**

我已经厌倦了在我的“代币之家”(一个小工作室，只有一个人的空间)工作，并决定搬到我的道的共同工作空间，在那里我可以会见一些社区成员，获得一杯免费的咖啡，并更自由地生活。令人惊讶的是，当我到达目的地，并通过我持有的道 NFT 进行验证时，发现该空间已经被预订满了。我去了另一个共同工作的地方，但为了进去，我必须买一张 NFT 的单日票。NFT 使用的是我不常使用的协议，所以除了适用的协议费用之外，我还必须为交易支付过桥费用。这些费用很烦人，但没有办法，所以我只能接受这样的事实:我必须习惯这些费用——没有办法使用它们。

尽管如此，这是富有成效的一天！我设法完成了一个化身的模型，用 NFT 包起来，挂牌出售。这实际上是我工作中最激动人心的时刻——甚至比实际销售更令人满意。你看，在交易完成后，所有的神秘都消失了，因为你已经知道了价格和你从中获得的硬币的数量。那没什么乐趣。但是，就在我真正列出新鲜 NFT 的那一刻，一切皆有可能——一切皆有可能。我可以梦想某个特别的人最终会注意到它，给我一个报价，那将是我进入一个完全不同的联盟的门票。

晚上，我决定和来自同一个 NFT 社区的朋友去喝一杯。我大约一年前就认识他们了，当时我有幸买了一辆流行的 NFT。作为交易的一部分，我被一个充满活力的社区所接受，在那里我享受着欢迎饮料，并与友好的人一起参加封闭的活动——这对我来说是一个特殊的时刻。即使你已经是 DAO 的一员，成为这样的团体的一员也很重要，因为在 DAO 中，每个人都至少有一个共同点:他们的动力主要来自作为持有会员资格的奖励而收到的佣金。这与普通社区的情况形成了鲜明的对比，在普通社区，情况正好相反:在那里，当你介绍新成员在你的推荐下购买 NFTs 时，你会收到佣金，但最重要的是你能遇到的人。社区领导(我们称他们为“影响者”)帮助设定价值观，并让每个人都有一种真正成为其中一部分的舒适感觉。

但是最近，出乎意料地，我的社区发生了一些变化。影响者开始提升一些社区成员到影响者的位置。这样做了之后，他们就对我们的团体失去了兴趣，把注意力转移到了一个新的社区，我听说他们在那里发行了一个全新的 NFT。

自从他们离开后，我们的社区继续发展，但是新的有影响力的人已经不如旧的人了，这个团体已经开始消亡。我的许多朋友已经离开，买了一些其他的社区 NFT。我也想这样做，但是由于价格太高，我买不起任何好的会员资格。我想我只能多存一点钱，多观察一会儿价格。

# 0b0110。**星期六。天鹅。”**

好消息！小扎克给了我一个模特的报价！提供的价格并不像一些新闻机构已经报道的那样高(现在有一整个行业都在关注名人钱包的内容)，但谁在乎呢！从现在开始，这将对我所有非功能性食物的价格产生深远的影响！看来我终于要发财成名了！我接受了这个提议，并开始等待和解。我没有立即收到确认，但我并不担心——我们谈论的是小扎克！我心中只有乐观，我整天都在计划我光明的未来！交易没有通过。

所有的消息应用都充满了对最近研究的讨论，该研究建议更新几乎所有区块链公共网络上的所有钱包。文章称，ECDSA 已经有 50 年的历史了，经验强烈表明是时候增加密钥长度了。事实上，这种变化可能早就应该发生了；以前，有了 RSA，长度大约每 20 年增加一次。现在，随着这种突然的变化和急于更新，当大约 30 亿拥有多个钱包的用户开始将硬币和代币从他们的短键地址转移到他们的长键新地址时，所有区块链网络都超载了。不出所料，所有的协议费用都暴涨了。

更糟糕的是，越来越明显的是，一个神秘的团体(据推测是由三流但聪明的黑暗矿工组成)找到了一种方法，用大约一年前开发的专门硬件悄悄地破解了旧的短 ECDSA 密钥。他们一直在等待这一时刻，从“被遗弃的”钱包中“套现”价值数十亿美元的资产。他们预先生成了数百万个私钥，这些私钥与公共分类帐上共享的公钥相对应，然后简单地将所有这些资产移动到他们自己的新的长键地址。在用完废弃的地址后，他们开始抢在拥有大量余额的真实地址的所有者之前，将硬币转移到他们自己的钱包里，并迅速将其转移到他们在 CBDC 网络上的账户上，以获得强大的菲亚特。我不敢相信这真的发生了。感觉像是世界末日。

很快(但对我们数百万人来说还不够快)，政府管理的 CBDC 连锁店的所有业务都被冻结了。至少在那些成功推出自己的 CBDCs 并从旧体系的灰烬中重新开始的国家中是这样的…

现在每个人都被要求去他们的银行，把他们的中央银行存款证转换成具有适当 KYC 的法定货币。那些把所有财富都藏在密码中的人现在正试图出售他们的 NFT，但是，令他们惊恐的是，他们意识到他们不能简单地把它们打印出来，然后卖给菲亚特。当然，NFT 令牌仍然是他们的，但他们不允许复制令牌内链接引用的内容来获利(法律在这一点上非常明确——任何试图这样做的行为都将被视为非法销售受版权保护的材料)。一些被剥夺者现在转向艺术界，艺术地重新描绘 NFT 的视觉效果，并正式使其成为衍生作品。也许这将使他们能够避免那些版权问题。

一个更积极的发展是，今天我收到了我奶奶寄来的一些纸币。她每年圣诞节都给我寄这些纸条…我希望我还没有把它们变成 CBDCs。直觉告诉我最好现在就去接他们。
