...
[https://www . ECB . Europa . eu/pub/economic-bulletin/articles/2018/html/ECB . ebart 201806 _ 03 . en . html](https://www.ecb.europa.eu/pub/economic-bulletin/articles/2018/html/ecb.ebart201806_03.en.html)

这些与数字欧元有什么关系？

嗯，一切。数字欧元是以“数字现金”的形式出现的。但是那看起来像什么？首先，我们必须问一个数字欧元是如何被“创造”或印刷出来的。对于钞票或现金，这很容易。中央银行印制欧元钞票，分发给银行，然后银行通过自动取款机向客户提供这些钞票。本质上，无论何时你从银行账户中取出现金，你基本上都是在要求银行兑现它欠你的钱的承诺。正如我前面说过的，当你的银行账户上有 1000€时，这意味着银行承诺它准备好了 1000€的现金供你支配。这么想吧。你账户上的 1000€就像你和银行之间的一份合同，上面写着“我欠马丁 1000€”。如果你以现金的形式要求，就好像你要求你的银行兑现承诺。一旦你有了那 1000€，如果你把它放在另一家银行，那家银行会为你开一个账户，并把 1000€存入你的账户。作为将这 1000€存入另一家银行的交换，你再次收到一个视觉承诺，即该银行欠你这 1000€(以你在银行账户上看到的余额的形式)。

但是，它将如何与数字欧元合作呢？从表面上看，人们可以直接在央行开立账户。如果是这样的话，它实际上就相当于现金，因为有了现金，除了央行之外就没有对手了。就债务资金而言，如上所述，总有一个交易对手或反向资产。出现在银行账户上的大部分现存货币之所以存在，只是因为在某个地方，有人同意偿还等量的债务。换句话说，与现金相反，货币只有短暂的寿命。整个金融体系的稳定依赖于货币的无缝创造/毁灭循环，这是商品和服务的创造/毁灭循环的一面镜子。在一个理想的世界里，你购买的商品应该只和最初用来创造它们的信用或金钱一样长久。例如，如果一个企业必须借 100 万€来生产 100，000 双鞋，并且必须在 5 年内偿还这笔贷款，那么在 5 年后，理想情况下，这 100，000 双鞋将被他们的客户扔掉，并因此从经济中“消失”,与此同时，为制造它们而创造的货币也从金融系统中消失。如果市场上的商品数量比货币数量多，就会出现通货紧缩(太少的货币追逐太多的商品)。如果与货币数量相比，市场上没有足够的商品，就会出现通货膨胀(过多的货币追逐过少的商品)。因此，你解决编程过时的梦想破灭了。这是当前以债务为基础的金融体系的一个重要特征。繁荣的二手市场实际上会扼杀经济和金融体系。最终，这就是现金的用途。这种“石油”促进了有限的二手、消费者对消费者的交易，比如你的庭院销售或你的 Facebook 市场交易。苹果公司太了解这个问题了，它臭名昭著的废弃旧手机政策，就像许多其他公司一样，他们更喜欢销毁产品而不是捐给穷人(比如时装和服装)。如果商品离开经济的速度与债务偿还的速度不一样或不相似，那么经济和金融系统就有麻烦了。

让我们追踪一位在欧洲中央银行开立数字欧元账户的客户。很有可能，要开立这样一个账户，客户必须通过 KYC 程序，这样账户就可以与他/她的身份直接挂钩。到目前为止，这很像在私人银行开户。除了这样一个帐户可以免费使用的事实之外，至少我是这样认为的。但是，麻烦开始了。为了用欧元向帐户“收费”,客户需要从另一个帐户接收欧元付款，或者从他/她的银行帐户向数字欧元帐户发送一些欧元。然而，这将如何工作呢？欧洲央行真的会为每个欧洲消费者生成一种“特殊的”IBAN 格式，比如 CBXX XXXX XXXX XXXX XXXX，以便能够将欧元发送到这样一个账户，然后在一个没有 IBAN 格式的特殊账户中将这笔钱转换成数字欧元吗？而这只是冰山一角。后端会发生什么？通常，当你从一家银行向另一家银行汇款时，流动的不仅仅是钱。资产/负债必须或多或少同步变动。换句话说，如果你将 1000€从 A 银行转移到 B 银行，你基本上是在转让一份合同或承诺，即 B 银行现在欠你转让 1000€的任何人的债。为了让 B 银行接受这一承诺，它会要求 A 银行转移某种价值 1000€的资产，如债券或现金。但这将如何与欧洲央行合作呢？它还会要求银行将其部分资产转移至资产负债表吗？然后，当欧洲央行将数字欧元转换回债务货币，并将其发送到一个银行账户时，它是否也会将其部分资产转移到该银行？这里有很多问题需要回答。例如，既然欧洲央行的资产负债表可以变成负值而不会产生任何影响，那么数字欧元是否可以被用来通过减轻银行持有欧元的责任来拯救银行呢？银行会利用欧洲央行的资产负债表几乎无懈可击的事实，在向欧洲央行输送一些债务资金欧元的同时，向欧洲央行输送垃圾债券或其它它希望抛售的无价值资产吗？

这也提出了一个问题，当有人想再次将数字欧元转换为私人银行债务货币时，到底会发生什么。欧洲央行会给银行送去抵押品，销毁数字欧元，并要求收款银行把债务资金记入此人的账户吗？简而言之，数字欧元的创造/毁灭周期需要澄清。

*   **这对银行有什么好处？**

如果数字欧元真的成功了，那么我不明白为什么人们还会在私人银行拥有银行账户，他们需要支付费用，而且在欧洲央行或央行层面不存在交易对手风险。在极端情况下，央行可以将所有现有的私人银行转变为分支机构。私人银行仍将出售保险、提供信贷和抵押贷款(或负责货币创造)，但资金将直接记入欧洲央行账户并转换成数字欧元，抵押品(债务合同)将转移到欧洲央行的资产负债表上。银行只会出售信用，但不会为此承担责任。这在道德风险和审慎风险方面引发了许多问题。在这种情况下，银行将保留利润(利息)，但不必承担违约风险。

*   **数字欧元会有什么限制，如果有的话？**

当然，任何限制都会让数字欧元的吸引力低于现有的数字银行货币或分散的稳定欧元。如果数字欧元能够完美地模仿现金的所有特征，那么它可能会有未来。这实质上意味着:

*   不，KYC:任何人都可以匿名开户。
*   完全隐私:交易是不可追踪和加密的。
*   完全非托管功能:任何第三方都不能任意冻结、阻止或以任何方式限制、约束或撤销交易。
*   离线能力:可以在不同设备之间汇款，而不必依赖互联网。这可以通过多种方式实现，但是利用网状网络可能是值得探索的事情。

最重要的是，允许数字欧元与智能合约兼容(使其可编程)，将真正把现金带入 21 世纪，并将金钱转化为真正的公共产品。

有些人可能害怕这样的数字欧元，因为这意味着放弃*的控制权*，这是任何当局自古以来就有麻烦的事情。事实上，这让我想到了我的第四点…

*   **变相命令经济？**

集中账本上的可编程货币有一个非常有趣的属性:如果它在一个集中实体的控制之下。欧洲央行目前为实现某些经济目标而使用的宏观经济政策工具，即利率水平和量化宽松，相当于用大锤打死一只蚊子。它会造成很大的伤害，但蚊子很可能会存活下来。10 多年来，自 2008 年金融危机以来，增长和通胀一直保持平稳，远未达到 2%的目标，尽管利率为零甚至为负。而现在，通胀率突然跃升至 10%。欧洲央行需要新颖的政策工具，而数字欧元很可能就是其中之一。可编程货币可以有如此多的用途:实施负利率以“刺激”消费，以某种方式惩罚反对“制度”的人(参见加拿大对组织加拿大和美国之间封锁的抗议者的制裁，或中国的社会评分系统)，防止人们购买非 ESG 友好型金融产品，甚至可能是被认为不可持续的常规产品，更普遍的是，将消费模式定位在更细粒度的水平上。 实时跟踪每一笔交易，以更好地监控经济和金融系统，并使用各种工具来微观管理支出，以各种方式使用收集到的支出数据(广告、信用评分或保险等风险溢价评估……)，当然，任何精通业务的公职人员都会申明，数字欧元将*永远不会*被用于那些反乌托邦目标。 然而……这就像制造了大量的核武器，并且相信它们永远不会被*使用。我们真的*相信*在未来，无论哪种类型的政府或政党掌权，这些工具都不会以这些方式使用吗？不过，我还是有点明白了。共产主义和资本主义似乎在玩一个小小的对换游戏。像中国这样的共产主义国家已经逐渐在他们的政治武库中加入了自由幻想的元素。消费资本主义在通过大量营销、广告和各种其他社会工程策略来人为创造需求方面极其强大，确保任何提议都会有需求。这是一个非常强大的系统，因为人们相信他们每次去超市都是免费的。这缓解了共产主义独裁和压迫政权的日常流行的情绪，并使大众远离像想要民主或自由这样的危险想法。另一方面，资本主义国家正在逐渐增加共产主义*指令经济*政策工具，因为它们对于实现某些目标非常实用。命令经济工具可以让行动更快，而不是通过宣传和营销来操纵人们，让他们相信特定的行为是为他们好，然后才强制执行。也许数字欧元和 ESG(环境、社会和治理)标准和分数是朝着这个方向迈出的步伐。可悲的是，最终，公共当局基于恐惧和控制，采取了这两个系统的两个最糟糕的 T21 特征，而不是两个最好的关于信任和自由的特征。与自由资本主义和关怀共产主义相对的操纵资本主义和控制共产主义。通常情况下，共产主义和资本主义之间的真正融合应该创造一个每个人的基本需求都得到满足的社会(关怀共产主义)，这允许每个人自由表达他们的才华(自由资本主义)，创造一个个人以各种形式自由表达的空间(艺术、工作、创造力……)，这将导致分散化的更高秩序或“群体智慧”效应的诞生，在这种情况下，经济将反映数十亿自由个人的分散化智慧，不再忙于为自己的生存而斗争或被各种私人和公共行为者操纵。我们的政策制定者似乎害怕他们的人民，认为如果你给人民那种自由，他们将在几年内消耗这个星球，人类将在原始资源匮乏、气候变化、灾难性自然灾害等恶劣条件下灭亡。因此，为了拯救人类自身，许多决策者可能有意或无意地将自己视为某种“救世主”，就像一位父亲拯救他们吸毒成瘾的青少年，将他或她带回家，置于他或她的安全、保护和非常严格的控制之下，因为他或她的孩子(公民)“不可信任”。*
